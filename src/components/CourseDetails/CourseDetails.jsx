    ...
    return (
      <Fragment>
        <Container className="mt-5">
          <Row>
            <Col lg={8} md={6} sm={12}>
              <h1 className="carouselDetailsText">
            ...
            <Col lg={4} md={6} sm={12}>
              <div className="widget_feature">
                ...
                <ul>
                  <li>
                    <FontAwesomeIcon className="iconBullets" icon={faUser} />
                    <span> Enrolled :</span> 1200 students
                  </li>

                  <li>
                    <FontAwesomeIcon className="iconBullets" icon={faClock} />
                    <span>Duration :</span> 2 hours
                  </li>

                  <li>
                    <FontAwesomeIcon
                      className="iconBullets"
                      icon={faClipboard}
                    />
                  ...
                  <li>
                    <FontAwesomeIcon className="iconBullets" icon={faClone} />
                    <span>Categories:</span> Technology
                  </li>

                  <li>
                    <FontAwesomeIcon className="iconBullets" icon={faTags} />
        ...
        <Container>
          <Row>
            <Col lg={6} md={6} sm={12}>
              <div className="widget_feature">
                <h1 className="carouselDetailsText"> Skill You Need </h1>
                <hr />
                <ul>
                  <li>
                    <FontAwesomeIcon
