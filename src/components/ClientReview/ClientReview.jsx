            ...
            <div>
              <Row className="text-center justify-content-center">
                <Col lg={6} md={6} sm={12}>
                  ...
                  />
                  <h2 className="reviewName">Religion Islam</h2>
                  <p className="reviewDescription">
                    Hi! I'm Religion Islam. I'm a web developer with a serious
                    love for teaching I am a founder of eLe easy Learning and a
            ...
            <div>
              <Row className="text-center justify-content-center">
                <Col lg={6} md={6} sm={12}>
                  ...
                  <p className="reviewDescription">
                    Hi! I'm Zij. I'm a web developer with a serious love for
                    teaching I am a founder of eLe easy Learning and a
                    passionate Web Developer, Programmer & Instructor.
                  </p>
                </Col>
              </Row>
